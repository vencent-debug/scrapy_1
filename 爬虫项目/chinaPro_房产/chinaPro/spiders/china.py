...
class ChinaSpider(CrawlSpider):
    ...
    start_urls = ['http://app.finance.china.com.cn/news/live.php?channel=%E5%9C%B0%E4%BA%A7&p=']

    link = LinkExtractor(allow=r'channel=%E5%9C%B0%E4%BA%A7&p=\d+')
#http://finance.china.com.cn/house/20210407/5540657.shtml
    link_detail = LinkExtractor(allow=r'http://finance.china.com.cn/house/.*?')
    print('可以的')
