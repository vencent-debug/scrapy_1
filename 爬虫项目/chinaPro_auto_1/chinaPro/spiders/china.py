...
class ChinaSpider(CrawlSpider):
    ...
    start_urls = ['http://app.auto.china.com.cn/news/my.php?cname=%E6%B1%BD%E8%BD%A6&p=']

    link = LinkExtractor(allow=r'cname=%E6%B1%BD%E8%BD%A6&p=\d+')

    link_detail = LinkExtractor(allow=r'http://auto.china.com.cn/news/special/.*?')
    print('可以的')
    ...
    def parse_item(self, response):
        ...
        print("我进来了")
        tr_list = response.xpath('/html/body/div[5]/div[1]/div[1]/div[1]/ul/li')  # /html/body/div[5]/div[1]/div[1]/div[1]/ul/li[1]/a[2]
        # print(tr_list)
        for tr in tr_list:
