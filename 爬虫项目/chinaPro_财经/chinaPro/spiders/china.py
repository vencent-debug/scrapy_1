...
class ChinaSpider(CrawlSpider):
    ...
    start_urls = ['http://app.finance.china.com.cn/news/live.php?channel=%E8%B4%A2%E7%BB%8F&p=']

    link = LinkExtractor(allow=r'channel=%E8%B4%A2%E7%BB%8F&p=\d+')

    link_detail = LinkExtractor(allow=r'http://\w.finance.china.com.cn/roll/\d+/\d+.shtml')
    print('可以的')
